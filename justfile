# compose-utils — baseline (composectl + upx) + systemd install.sh extras
...
# Install binary into ~/.local/bin (default) or /usr/local/bin (--system, via sudo)
...
# ---------------------------------------------------------------------------
# Specials — systemd / compose project install (not the binary path above)
# ---------------------------------------------------------------------------

# Interactive or scripted systemd/compose setup (see systemd/install.sh)
